                                ...
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        if ($recommendations != null) {
                                            if (!empty($recommendations['rate'])) {
                                                foreach ($recommendations['rate'] as $k => $data) { ?>
                                                    <tr>
                                                        <td><?= "USERS " . $k ?></td>
                                                ...
                                                ?>
                                                    <tr>
                                                        <td colspan="20" class="text-center">Data Tidak Tersedia</td>
                                                    </tr>
                                            <?php }
                                        }  ?>
                                    </tbody>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!empty($recommendations['similar'])) {
                                            foreach ($recommendations['similar'] as $k => $data) { ?>
                                                <tr>
                                                    <td>
                                                        <?= $k ?>
                                                    </td>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example2" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        <?php
                                        if (!empty($recommendations['similarSum'])) {
                                            foreach ($recommendations['similarSum'] as $k => $data) { ?>
                                                <tr>
                                                    <td>
                                                        <?= $k ?>
                                                    </td>
