...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jul 2021 pada 17.34
...
(28, NULL, 2, 8, 1, 55000, 0, '2021-07-11', NULL, 'dsadsa', 'cbimage.png');
...
--
ALTER TABLE `tb_kuesioner`
  MODIFY `id_kuesioner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
